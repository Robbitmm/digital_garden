...
## I. Determine a Potência Projetada
$HPP = hp * Fs$

HPP = Potência Projetada
hp = Potência do motor
Fs = Fator de Serviço
## II. Determine a Polia

$D = d * \frac{RPMmaio}{RPMmenor}$
$D = d * i$
...
## III. Comprimento experimental da Polia
...
$C = 2000 - (180/2) - (217,8/2) - 1000 (circulação) = 801,1mm$ -> 596,7
...
### Recalculo da Distância entre Centros
$A = Lc - 1,57*(D+d)$
